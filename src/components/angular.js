...
export class AngularJSProject extends Component {
  render() {
    return (
      <div>
        <div className="projects-grid">
          <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
            ...
            <CardText>First Angular App</CardText>
            <CardActions border>
          ...
          <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
            ...
            <CardText>Second Angular App</CardText>
            <CardActions border>
              <Button colored>Github</Button>
              <Button colored>LiveDemo</Button>
            </CardActions>
          ...
          <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
            ...
            <CardText>Third Angular App</CardText>
            <CardActions border>
              <Button colored>Github</Button>
              <Button colored>LiveDemo</Button>
            </CardActions>
...
export default AngularJSProject;
