...
export class MongoDBProject extends Component {
  render() {
    return (
      <div>
        <div className="projects-grid">
          ...
          <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
            ...
            <CardText>Second MongoDB Project</CardText>
            <CardActions border>
              <Button colored>Github</Button>
              <Button colored>LiveDemo</Button>
            </CardActions>
          ...
          <Card shadow={0} style={{ width: "450px", margin: "auto" }}>
            ...
            <CardText>Third MongoDB Project</CardText>
            <CardActions border>
              <Button colored>Github</Button>
              <Button colored>LiveDemo</Button>
            </CardActions>
